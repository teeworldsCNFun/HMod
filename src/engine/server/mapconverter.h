...
class CMapConverter : protected CLuaClass
{
    friend class CLua;
public:
	enum
...
protected:
    ...
    void InitQuadLua(CQuad* pQuad) { InitQuad(pQuad); }
    void InitQuadPosLua(CQuad* pQuad, vec2 Pos, vec2 Size) { InitQuad(pQuad, Pos, Size); }
