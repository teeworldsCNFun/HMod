...
void CPickup::Tick()
{
	...
	{
		bool Skip = false;
		MACRO_LUA_CALLBACK_RESULT_V("OnPickedUp", Skip=, pChr)
		if(!_LUA_EVENT_HANDLED || !Skip)
		{
				...
				case POWERUP_NINJA:
					{
						...
						CCharacter *pC = dynamic_cast<CCharacter *>(GameServer()->m_World.FindFirst(CGameWorld::ENTTYPE_CHARACTER));
